...
for i=1:numel(loseline_single)
    ...
    temp(i)=[];
    if KL_single(i)<max([temp E_single_dbl(i,:)])-0.01 %plus epsilon for rounding errors
...
percent=count/length(loseline_dbl) %about 36%
