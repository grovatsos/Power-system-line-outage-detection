...
%8/6/14: This code computes the false alarm rate by sampling. Threshold A is chosen from Beta
...
Beta=100; %beta 10 ADD=98, beta 5 ADD= 59
...
%         rng(seed)
        ...
        Q=-bus(2:end,7);
        P_sample=P+randn(numel(P),1)*0.5;
        Q_sample=Q+randn(numel(Q),1)*0.2;
...
KL_FA2=-KL_compute(sigma0,sigma{2});
KL_FA8=-KL_compute(sigma0,sigma{8});
KL_FA7=-KL_compute(sigma0,sigma{7});
KL_FA3=-KL_compute(sigma0,sigma{3});
KL_FA4=-KL_compute(sigma0,sigma{4});
% 
figure;
