...
% hold on, grid on;
p1=plot(1:tao, Wnvec(1:tao,1)','--g', 'LineWidth', 2, 'Marker', '*', 'Markersize', 6);
p2=plot(1:tao, Wnvec(1:tao,2)','--b', 'LineWidth', 2,'Marker', 'o','Markersize', 6);
...
l1=legend([p1, p2, p3], '$W^{CU}_{(1,2)}$','$W^{CU}_{(1,3)}$','$W^{CU}_{(2,3)}$', 'Location', 'northwest');
