clear all
close all
%Code for generating detection delay and false alarm data
...
[J0 B0 B loseline] = makeB(case118);
...
beta = [1 6 12 24 48 168]; %hour
Lbeta = nlose*30*3600.*beta; %3600 seconds in an hour and assume 30 samples/sec
...
FA = 0; %1 is for false alarm testing
out = 91;
line_post = line;
if ~FA
...
save('L75out_XJ.mat', 'Avec', 'beta', 'ADDvec','PFI_g0','line_IDed');