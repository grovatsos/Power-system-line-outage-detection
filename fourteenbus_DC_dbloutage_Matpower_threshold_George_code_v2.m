...
% end
num_samplepaths=10000;
y=theta0;
ADD=Inf;
%run sample paths
%scale thresholds according to KL divergences
A_single=(2500*KL_single(:,1)/max(KL_single(:,1)))'+100;
% A_single=2500*ones(1, numel(loseline_single)); %Threshold
