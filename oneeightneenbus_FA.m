...
A_single=8*ones(1, numel(loseline_single)); %Threshold
...
%             disp(['False Alarm! Single line outage streams ', num2str(f_single), ' crossed the treshold ', num2str(A_single(f_single))]);
