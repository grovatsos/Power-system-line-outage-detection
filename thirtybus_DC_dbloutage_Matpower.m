...
l1=legend([p1, p2, p3, p4], '$W_{3}$','$W_{5}$','$W_{2}$', '$W_{6}$');
...
% seed=4;
% rng(seed)
linefault_dbl=[3 8]; %choose the two lines that are outaged [3 19] [3 20] show good paths, [6 9] produce example of case where line 5 single outage rate is faster than line 2 
...
l1=legend([p1, p2, p3, p4, p5, p6], '$W_{(dbl)}$','$W_{(dbl 3)}$', '$W_{(dbl 4)}$','$W_{(3)}$','$W_{(8)}$', '$W_{(3)}$');
