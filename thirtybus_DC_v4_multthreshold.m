...
Psig = 0.01; %use 0.05 for 14 bus, 0.1 for 3 bus, this does affect KL divergence so in theory, it shouldn't affect ADD
...
p3=plot(1:tao, Wnvec(1:tao,5)','--r', 'LineWidth', 2,'Marker', 's','Markersize', 6);
